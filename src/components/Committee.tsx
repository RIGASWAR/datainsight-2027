      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="p-7 sm:p-9 rounded-3xl bg-white border-2 border-[#D9A441]/50 shadow-xl text-center relative overflow-hidden group hover:border-[#D9A441] transition-all">
            ...
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-extrabold bg-[#D9A441]/15 text-[#D9A441] border border-[#D9A441]/40 mb-4 uppercase tracking-wider">
              <Sparkles className="w-3.5 h-3.5" />
              CHIEF PATRON
            </div>

            <div className="w-20 h-20 mx-auto rounded-full bg-gradient-to-tr from-[#D9A441] to-[#F5CE68] p-0.5 shadow-md shadow-[#D9A441]/20 mb-4 group-hover:scale-105 transition-transform">
              <div className="w-full h-full rounded-full bg-white flex items-center justify-center">
                <User className="w-9 h-9 text-[#D9A441]" />
              </div>
            </div>

            <h3 className="text-2xl sm:text-3xl font-extrabold text-[#0B2D6B] tracking-tight">
              {CONFERENCE_DATA.committee.chiefPatron.name}
            </h3>
            <p className="text-sm sm:text-base font-semibold text-[#176BFF] mt-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-10">
          ...
          <motion.div 
            ...
            className="p-7 rounded-2xl bg-white border border-[#176BFF]/20 hover:border-[#176BFF]/50 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all text-center flex flex-col items-center justify-center space-y-3"
          >
            <span className="px-3 py-0.5 rounded-full text-xs font-bold bg-[#176BFF]/10 text-[#176BFF] border border-[#176BFF]/20 uppercase tracking-wider">
              PATRON
            </span>
            <div className="w-16 h-16 rounded-full bg-[#F5F9FF] border-2 border-[#176BFF]/30 flex items-center justify-center text-[#176BFF] shadow-sm">
              <User className="w-8 h-8" />
            </div>
            <div>
              <h4 className="text-xl font-bold text-[#0B2D6B]">
                {CONFERENCE_DATA.committee.patron.name}
              </h4>
              <p className="text-xs sm:text-sm font-semibold text-[#174EA6] mt-0.5">
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-[#1A2B4A]/70">
        ...
        <div className="max-w-4xl mx-auto mb-14">
          <div className="text-center mb-6">
            <h4 className="text-sm font-extrabold uppercase tracking-widest text-[#D9A441]">
              ORGANIZING SECRETARIES
            </h4>
            <div className="w-12 h-0.5 bg-[#D9A441] mx-auto mt-2 rounded-full" />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            {CONFERENCE_DATA.committee.organizingSecretaries.map((sec, idx) => (
              <motion.div
                ...
                className="p-6 rounded-2xl bg-white border border-[#176BFF]/15 hover:border-[#176BFF]/40 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all text-center space-y-2.5"
              >
                <div className="w-12 h-12 mx-auto rounded-full bg-[#F5F9FF] border border-[#176BFF]/20 flex items-center justify-center text-[#176BFF]">
                  <User className="w-6 h-6" />
                </div>
                <h5 className="text-base font-bold text-[#0B2D6B]">
                  {sec.name}
                </h5>
                <p className="text-xs text-[#174EA6] font-medium">
                  {sec.role}
                </p>
                <p className="text-[11px] text-[#1A2B4A]/70">
        ...
        >
          <div className="text-center mb-6">
            <h4 className="text-xs font-bold uppercase tracking-widest text-[#174EA6]">
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full p-4 text-left flex items-center justify-between text-xs font-bold text-[#0B2D6B] focus:outline-none"
                  >
                    <span>{role.category}</span>
                    <div className="flex items-center gap-2">
                      <span className="text-[10px] text-[#D9A441] font-mono font-semibold px-2 py-0.5 rounded bg-[#FFF9E6] border border-[#D9A441]/30">
                        {role.status}
                      </span>
                      {isExpanded ? (
                        <ChevronUp className="w-4 h-4 text-[#176BFF]" />
                      ) : (
                        <ChevronDown className="w-4 h-4 text-[#174EA6]" />
                      )}
                    </div>
                  </button>
                  ...
                  <AnimatePresence>
                    {isExpanded && (
                      <motion.div 
                        ...
                        className="px-4 pb-4 pt-1 text-[11px] text-[#1A2B4A]/80 border-t border-[#176BFF]/10 bg-[#F5F9FF] overflow-hidden space-y-1"
                      >
                        <p>
