              ...
              >
                ...
                <div className="relative w-full aspect-square bg-gradient-to-b from-[#F5F9FF] to-[#EBF3FF] flex items-center justify-center overflow-hidden border-b border-[#176BFF]/10 group-hover:from-[#EBF3FF] group-hover:to-[#DCEBFF] transition-colors">
                  ...
                  <div className="relative w-28 h-28 rounded-2xl bg-white border-2 border-dashed border-[#176BFF]/30 flex flex-col items-center justify-center text-center p-3 group-hover:scale-105 group-hover:border-[#176BFF] transition-all duration-300 shadow-sm">
                    ...
                    <span className="text-[10px] font-bold text-[#174EA6] mt-1.5 uppercase tracking-wider">
                      Slot 0{index + 1}
                    </span>
                  </div>

                  {/* Badge */}
                  <div className="absolute top-3 right-3 px-2.5 py-1 rounded-full text-[10px] font-bold bg-[#D9A441]/15 text-[#D9A441] border border-[#D9A441]/30 backdrop-blur-md">
                    To Be Announced
                  </div>
                </div>
                ...
                <div className="p-5 flex-1 flex flex-col justify-between space-y-4 bg-white">
                  <div>
                    ...
                    <h3 className="text-base font-bold text-[#0B2D6B] mt-1 group-hover:text-[#176BFF] transition-colors">
                      {speaker.name}
                    </h3>

                    <div className="mt-2 space-y-1 text-xs text-[#1A2B4A]">
                      <div className="flex items-center gap-1.5">
                        <span className="text-[#1A2B4A]/70">Role:</span>
                        <span className="font-medium text-[#0B2D6B]">{speaker.designation}</span>
                      </div>
                      <div className="flex items-center gap-1.5">
                        <span className="text-[#1A2B4A]/70">Affiliation:</span>
                        <span className="font-medium text-[#0B2D6B]">{speaker.institution}</span>
                      </div>
                      <div className="flex items-center gap-1.5">
                    ...
                    <div className="mt-3 pt-3 border-t border-[#176BFF]/10 text-xs text-[#1A2B4A]/75 italic">
                      Biography: {speaker.biography}
                    </div>
                  </div>

                  {/* Social Profile Placeholder Bar */}
                  <div className="pt-3 border-t border-[#176BFF]/10 flex items-center justify-between text-xs text-[#1A2B4A]/70">
                    <div className="flex items-center gap-2">
                      <span className="w-7 h-7 rounded-lg bg-[#F5F9FF] border border-[#176BFF]/10 flex items-center justify-center text-[#174EA6] hover:text-[#176BFF] hover:bg-[#EBF3FF] transition-colors" title="Professional Network">
                        <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
                          <path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.28 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.75M6.88 8.56a1.68 1.68 0 0 0 1.68-1.68c0-.93-.75-1.69-1.68-1.69a1.69 1.69 0 0 0-1.69 1.69c0 .93.76 1.68 1.69 1.68m1.39 9.94v-8.37H5.5v8.37h2.77z"/>
                        </svg>
                      </span>
                      <span className="w-7 h-7 rounded-lg bg-[#F5F9FF] border border-[#176BFF]/10 flex items-center justify-center text-[#174EA6] hover:text-[#176BFF] hover:bg-[#EBF3FF] transition-colors" title="Academic Email">
