    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-fade-in">
      ...
      >
        ...
        <div className="flex items-center gap-3.5">
          ...
          <div>
            <span className="inline-block px-3 py-1 rounded text-xs font-extrabold uppercase tracking-wider bg-[#FFF9E6] text-[#D9A441] border border-[#D9A441]/30">
              {content.statusBadge}
            </span>
            <h3 className="text-2xl font-extrabold text-[#0B2D6B] mt-1">
              {content.title}
            </h3>
          </div>
        </div>
        ...
        {/* Subtitle & Message */}
        <div className="space-y-3 pt-2.5 border-t border-[#176BFF]/10">
          <p className="text-base font-semibold text-[#174EA6]">
            {content.subtitle}
          </p>
        ...
        <div className="p-4 rounded-xl bg-[#F5F9FF] border border-[#176BFF]/15 flex items-center justify-between text-sm">
        ...
        <div className="pt-2">
          <button
            onClick={onClose}
            className="w-full py-3.5 px-5 rounded-xl font-bold text-sm sm:text-base bg-gradient-to-r from-[#176BFF] to-[#00A8E8] text-white shadow-md hover:brightness-105 active:scale-95 transition-all text-center cursor-pointer"
          >
            Understood
          </button>
        </div>
