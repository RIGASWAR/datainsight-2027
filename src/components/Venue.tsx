      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="relative rounded-3xl bg-white border-2 border-[#176BFF]/20 overflow-hidden shadow-xl group hover:border-[#176BFF]/40 transition-colors">
              ...
              <div className="relative w-full aspect-[4/3] bg-gradient-to-br from-[#F5F9FF] via-[#EBF3FF] to-[#E0EDFF] flex flex-col items-center justify-center p-8 text-center overflow-hidden">
                ...
                <div className="relative z-10 space-y-1">
                  <span className="inline-block px-3 py-1 rounded-full text-xs font-bold bg-[#D9A441]/15 text-[#D9A441] border border-[#D9A441]/30">
                    CAMPUS PHOTOGRAPH PLACEHOLDER
                  </span>
                  <h3 className="text-xl sm:text-2xl font-extrabold text-[#0B2D6B] mt-2">
                ...
                <div className="absolute bottom-4 left-4 right-4 p-3 rounded-xl bg-white/90 backdrop-blur-md border border-[#176BFF]/20 shadow-sm flex items-center justify-between text-xs">
              ...
              <div className="p-5 bg-[#F5F9FF] border-t border-[#176BFF]/15 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                  <div className="text-xs font-bold text-[#0B2D6B]">Interactive Location Services</div>
                  <div className="text-[11px] text-[#1A2B4A]/70">GPS Coordinates: Peelamedu, Coimbatore</div>
                </div>
                <button
                  onClick={onMapClick}
                  className="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-xl text-xs font-bold bg-[#176BFF] hover:bg-[#1255cc] text-white shadow-md border border-[#176BFF]/30 hover:-translate-y-0.5 active:translate-y-0 transition-all"
                >
          ...
          >
            ...
            {/* Address Banner */}
            <div className="p-6 rounded-2xl bg-white border border-[#176BFF]/20 shadow-sm space-y-2 hover:border-[#176BFF]/40 transition-colors">
              <div className="flex items-center gap-2 text-xs font-bold text-[#D9A441] uppercase tracking-wider">
              ...
              {CONFERENCE_DATA.venue.subsections.map((sub, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="p-4 rounded-xl bg-white border border-[#176BFF]/15 hover:border-[#176BFF]/35 hover:-translate-y-0.5 shadow-sm transition-all flex items-center justify-between gap-4"
                  >
                    <div className="flex items-center gap-3.5">
                      <div className="w-9 h-9 rounded-lg bg-[#F5F9FF] border border-[#176BFF]/20 flex items-center justify-center text-[#176BFF] flex-shrink-0">
                        <IconComp className="w-4 h-4" />
                      </div>
                      <div>
                        <h4 className="text-xs sm:text-sm font-bold text-[#0B2D6B]">
                          {sub.title}
                        </h4>
                        <span className="text-[11px] text-[#1A2B4A]/70">
                          Local Travel Guidance
                        </span>
                      </div>
                    </div>

                    <span className="text-[11px] font-mono font-bold px-2.5 py-1 rounded bg-[#FFF9E6] text-[#D9A441] border border-[#D9A441]/30 flex-shrink-0">
                      {sub.info}
                    </span>
                  </motion.div>
                );
